...
#' @param Params Params is a list with Params$SiteNames, Params$M, Params$k, Params$Linf for all sites.  These can be uploaded by loading NERRdata.Rdata
#' @param CovMats CovMats is a list with the covariance matrices for M, Linf, and k (in that order) for the sites.  These can be uploaded by loading NERRdata.Rdata
#' @keywords NERR
#' @export
#' @examples 
